...
def lab3():
    ...
    print('Матриця планування експерименту для m=3:')
    ...
    ynlist = []
    print('Знайдемо середнє значення відгуку за рядками:')
    ...
    b2 = det2 / det4
    b3 = det3 / det4
    print('Підставивши отримані значення:')
    print('bo=', b0, '\nb1=', b1, '\nb2=', b2, '\nb3=', b3 )
    ...
    def perevirky():
        ...
        f4 = 4 - d
        f3 = 8
        print('\nОскільки f3=8, то коефіцієнти b1, b2 приймаємо незначущими при рівні значимущості 0,05, '
